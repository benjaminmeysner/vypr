...
namespace Vypr.Server.Authorisation.Policy
{
    ...
    using Vypr.Server.Attributes;
    using Vypr.Server.Authentication.Managers;

    /// <summary>
    /// Role Authorization Policy
    /// </summary>
    /// <seealso cref="Vypr.Server.Authorisation.Attributes.AttributeAuthorizationHandler{Vypr.Server.Authorisation.Policy.VyprAuthorizationRequirement, Vypr.Server.Authorisation.Attributes.MustBeRoleTypeOrAbove}" />
    public class VyprAuthorizationPolicy : AttributeAuthorizationHandler<AuthorizationRequirement, VyprCore.Utilities.Attributes.AuthorizeAttribute>
    {
        /// <summary>
        /// The user manager
        /// </summary>
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, AuthorizationRequirement requirement, IEnumerable<VyprCore.Utilities.Attributes.AuthorizeAttribute> attributes)
        {

...
namespace Vypr.Server.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(VyprSignInManager signInManager, VyprUserManager userManager, IEmailTemplater emailTemplater, IHttpContextAccessor httpContextAccessor)
        {

...
namespace Vypr.Server.Extensions
{
    ...
    using Vypr.Server.Authentication.Factory;
    using Microsoft.AspNetCore.Authorization;
    using VyprCore.Models.Domain;
    using Vypr.Server.Authorisation.Policy;
    ...
    public static class IdentityExtensions
    {
            ...
            where TDbContext : DbContext
        {
            ...
            services.AddSession().Configure<WebAuthnConfig>(webAuthConfig);
        ...
        /// <param name="services">The services.</param>
        /// <returns></returns>
        private static IServiceCollection AddWebAuthn<TDbContext>(this IServiceCollection services, Action<WebAuthnConfig> config = null)
            where TDbContext : DbContext
        {
            ...
            var fidoConfig = new WebAuthnConfig();
            config(fidoConfig);

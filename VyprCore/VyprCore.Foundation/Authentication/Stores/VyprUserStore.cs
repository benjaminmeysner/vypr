...
namespace VyprCore.Foundation.Authentication.Stores
{
    ...
    /// Vypr User Store
    /// </summary>
    /// <seealso cref="Microsoft.AspNetCore.Identity.EntityFrameworkCore.UserStore{VyprCore.Foundation.Authentication.Classes.VyprUser, VyprCore.Foundation.Authentication.Classes.VyprRole, VyprCore.Foundation.DbContext.VyprDbContext, System.Int32, VyprCore.Foundation.Authentication.Classes.VyprUserClaims, VyprCore.Foundation.Authentication.Classes.VyprUserTenantRoles, VyprCore.Foundation.Authentication.Classes.VyprUserLogins, VyprCore.Foundation.Authentication.Classes.VyprUserTokens, VyprCore.Foundation.Authentication.Classes.VyprRoleClaims}" />
    public class VyprUserStore : UserStore<VyprUser, VyprRole, VyprDbContext, int, VyprUserClaim, VyprUserRole, VyprUserLogin, VyprUserToken, VyprRoleClaim>
    {
        ...
        {
            throw new NotImplementedException("Please use GetRolesAsync with Tenant");
        }

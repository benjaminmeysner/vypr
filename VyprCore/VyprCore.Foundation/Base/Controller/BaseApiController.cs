...
namespace VyprCore.Foundation.BaseClasses.Controller
{
    ...
    [ApiController]
    [Authorize]
    public abstract class BaseApiController<TEntity, TEntityViewModel, TRepository, TStrategy> : ControllerBase
        ...
        where TRepository : IRepository<TEntity>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseApiController{TEntity, TEntityViewModel, TRepository, TStrategy}"/> class.
        /// </summary>
        /// <param name="strategy">The strategy.</param>
        public BaseApiController(IStrategy<TEntity, TEntityViewModel, TRepository> strategy)
        {
